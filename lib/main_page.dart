    ...
    if(widget.index == null){
      ...
      if(widget.index == 1){
        Fluttertoast.showToast(
            msg: (widget.page=="Add")?"Category Added Successfully":"Category Updated Successfully" ,
      ...
      if(widget.index == 2){
        Fluttertoast.showToast(
            msg: (widget.page=="Add")?"Project Added Successfully":"Project Updated Successfully" ,
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.BOTTOM,
            // timeInSecForIos: 1,
            backgroundColor: Colors.grey,
      ...
      if(widget.index == 3){
        Fluttertoast.showToast(
            msg: (widget.page=="Add")?"Task Added Successfully":"Task Updated Successfully" ,
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.BOTTOM,
            // timeInSecForIos: 1,
            backgroundColor: Colors.grey,
